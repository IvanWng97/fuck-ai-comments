...
use super::javascript::classify_comment as classify_javascript_comment;
use super::javascript::{owner_from_node, prefixed_span};
use super::tree::{
    AttachmentIndex, DirectivePlacement, LanguageSpec, OwnerCandidate, OwnerLocation, analyze,
    canonical_syntax, direct_named_child, document, node_text,
};
...
impl LanguageSpec for TypeScript {
    ...
    fn owner(
        ...
        typescript_owner(node, location, source).or_else(|| owner_from_node(node, location, source))
    }
